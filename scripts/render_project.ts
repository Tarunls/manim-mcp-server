...
const render = await renderIncrementally(root, projectDir, project, new RenderCache(path.join(root, "studio", "cache")));
...
await createProxy(output, path.join(projectDir, "proxy.mp4"));
