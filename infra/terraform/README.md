...
Current staging is deployed with application/E2B tag `004c9c7`. Candidate application image `c74eb0d` is built, but its matching E2B template and end-to-end narrated certification are pending. Read `docs/GCP_ADMIN_LLM_HANDOFF.md` before changing tfvars or applying.
